		...
		<div class="main-header--container container">
			<nav class="main-header--nav">
				...
				<ol class="main-header--list main-header--list__hide">	  
					<li class="main-header--item"><a class="main-header--link" href="#main" data-toggle-main="true" data-smooth="true">Гавная</a></li>
			...
			<p class="main-header--purchase">
				...
				<button class="main-header--orders">
					...
					<span class="main-header--buy">Перейти к оформлению заказа</span>
